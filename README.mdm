...
La industria tabacalera desarrolla sus actividades comerciales mediante diferentes canales de distribución y venta, entre ellos la preventa, con el objetivo de garantizar la disponibilidad de sus productos y atender la demanda de los clientes en una región determinada.
...
Como consecuencia, resulta más difícil identificar los mercados con mayor impacto, reconocer patrones en los rechazos y establecer estrategias orientadas a mejorar la efectividad de las entregas. A partir de este análisis se busca generar información que facilite la toma de decisiones y contribuya a definir acciones de mejora basadas en evidencia.
